    ...
    <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-gray-100">Admin</h1>
            </div>
      ...
      {isSuperAdmin && (
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-900/40 rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            <h3 className="font-semibold text-red-900 dark:text-red-200">Admin Access</h3>
