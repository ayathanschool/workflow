      ...
      Object.keys(teacherPeriods).forEach(teacherEmail => {
        ...
        periods.forEach(tt => {
          ...
          result.push({
            ...
            regularSubject: tt.regularSubject || '',
            substituteTeacher: tt.substituteTeacher || '',
            substituteSubject: tt.substituteSubject || '',
            isExchange: tt.isExchange === true || String(tt.isExchange || '').toLowerCase() === 'true',
            exchangeNote: tt.exchangeNote || tt.note || '',
